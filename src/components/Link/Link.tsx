  ...
  return (
    <a
      ...
      className={`
        ...
        ${variant === "bordered" ?
          "text-main-dark dark:text-main-light dark:bg-bg-soft light:hover:bg-main-dark light:hover:text-white dark:hover:text-main dark:hover:border-main border-small border-main-dark dark:border-main-light"
        :
